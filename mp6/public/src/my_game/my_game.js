...
import MultiTextureTest from "./multi_texture_test.js";
...
class MyGame extends engine.Scene {
    ...
    init() {
        ...
        // passing in two textures
        this.mObjPete = new MultiTextureTest(3, 2, 4, 2.5, this.kPete, this.kUp);
        this.mObjMenu = new MultiTextureTest(7, 6, 4, 2.5, this.kPeteMenu, this.kF);
        this.mObjSprite = new MultiTextureTest(2.5, 6, 4, 2.5, this.kMinionSprite, this.kUp);
